...
enum ServerConfigs
{
    ...
    CONFIG_RANDOM_LEVEL_LOOT_ENABLE,
    CONFIG_RANDOM_LEVEL_LOOT_LEVELS_BELOW,
    CONFIG_RANDOM_LEVEL_LOOT_MIN_QUALITY,
    CONFIG_RANDOM_LEVEL_LOOT_MAX_ITEM_LEVEL,
    CONFIG_RANDOM_LEVEL_LOOT_CHANCE_COMMON,
    CONFIG_RANDOM_LEVEL_LOOT_CHANCE_RARE,
    CONFIG_RANDOM_LEVEL_LOOT_CHANCE_EPIC,
    CONFIG_RANDOM_LEVEL_LOOT_POTION_CHANCE,
    CONFIG_RANDOM_LEVEL_LOOT_POTION_LEVELS_BELOW,
